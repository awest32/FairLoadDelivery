...
weight_ids_fin = []
iterations = 10
fair_func = "efficiency" # Options: "proportional", "efficiency", "min_max", "jain", "palma"
case = "motivation_a"
save_path = "results/$(Dates.today())/$case/$fair_func/"
create_save_folder(case, fair_func)

# Function to run the relaxed FLDP for a given number of iterations
...
math_relaxed, pshed_lower_level, pshed_upper_level, weight_ids_fin, model = relaxed_fldp(math_new, iterations, fair_weights, fair_func, save_path)
...
# Determine the violated constraints from the AC feasibility tests
# Check the voltage violations
